...
CREATE TABLE `transactions` (
  ...
  `type` enum('payment_received','payment_done','payment_transferred') DEFAULT NULL,
  `amount` decimal(10,2) NOT NULL,
  `date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `receiver_customer_id` int DEFAULT NULL,
  `receiver_supplier_id` int DEFAULT NULL,
...
INSERT INTO `transactions` VALUES (1,2,NULL,'faisal','payment_received',90.00,'2025-03-19 15:57:42',NULL,NULL),(2,1,NULL,'abdullah','payment_received',30.00,'2025-03-25 17:50:48',NULL,NULL);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_insert_transactions` BEFORE INSERT ON `transactions` FOR EACH ROW BEGIN
    ...
    SELECT supplier_name INTO supplierName 
    FROM suppliers 
    WHERE supplier_id = NEW.supplier_id 
    LIMIT 1;

    -- Set the name field to customer_name if exists, otherwise supplier_name
    SET NEW.name = COALESCE(customerName, supplierName);
END */;;
DELIMITER ;
